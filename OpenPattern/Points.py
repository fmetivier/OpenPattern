...
class Point(object):
    ...
    def __init__(
        ...
        # By defualt record all changes made si they can be cancelled on demand
        self.track = [(pos[0], pos[1])]
    ...
    def add(self, *args):
        ...
        if len(args) == 1:
            ...
            if isinstance(p, Point):
                ...
                isinstance(p, np.ndarray) or isinstance(p, list) or isinstance(a, tuple)
            ):
    ...
    def scal(self, *args):
        ...
        if len(args) == 1:
            ...
            if isinstance(a, int) or isinstance(a, float):
                ...
                isinstance(a, np.ndarray) or isinstance(a, list) or isinstance(a, tuple)
            ):
                change = False
