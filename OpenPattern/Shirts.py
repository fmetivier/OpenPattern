...
class Shirt(Basic_Bodice):
	...
	def __init__(self, pname="M44G", gender='m', style='Chiappetta', age=99, ease=8, hip=True, Back_Front_space = 12, collar_ease = 1, sleeve_lowering = 2.5, side_ease = 4, shoulder_ease = 2):
